...
z=flipud(x); #atribuindo à variável z o valor de uma função no octave que reflete a onda com relação ao eixo y
...
player = audioplayer(x, fs*fator); #armazenando em player o valor de audioplayer, que possibilita a reprodução da mídia futuramente. Note que o valor da frequência de amostragem está a ser multiplicado pelo fator. Aqui foram testadas tanto a variável x quanto z.
